...
| 4 | Miniera di Lacrime | Conquista · +2 PV | conditional | comune | 2 |
...
| 8 | Cripta dei Sussurri | Post-scontro · Perdente · +1 FC | conditional | comune | 1 |
| 9 | Porte di Atlantide | Calcolo VA · Entrambi · FC ×2 | focus | special | 1 |
| 10 | Nido di Spine | Conquista · −5 PV | conditional | raro | 1 |
| 11 | Canyon delle Lame | Ultimo Desiderio · −2 PV | conditional | comune | 1 |
| 12 | Torre d'Avorio | Conquista · +1 FC | conditional | comune | 1 |
...
| 37 | Trono Solare | Conquista · +1 PV | conditional | comune | 2 |

## Kethran *(6)*

| id | Nome | Effetto | category | rarità | minTurn |
|----|------|---------|----------|--------|---------|
| 22 | Fondamenta della Torre | Gloria, Vendetta sempre attivo | trigger | raro | 2 |
| 23 | Ziqqurat Spezzata | Post-scontro · Perdente · +1 FC · Conquista · −1 FC | conditional | comune | 1 |
| 24 | Biblioteca delle Lingue Perdute | Regola · Effetti Blocca disattivati | limit | raro | 1 |
| 38 | Trono dei Re Caduti | Conquista · −1 PV (DAN dir.) | conditional | comune | 1 |
| 39 | Mura della Sfida | Regola · Rimonta · sempre attivo | trigger | raro | 2 |
| 56 | Falso idolo | Rimonta · +3 VA | conditional | raro | 2 |

## Corte Rossa *(6)*

| id | Nome | Effetto | category | rarità | minTurn |
|----|------|---------|----------|--------|---------|
| 25 | Sala dei Contratti | Conquista · −2 FC | conditional | comune | 1 |
...
| 40 | Tribunale dell'Anima | Post-scontro · Perdente · −1 FC | conditional | comune | 1 |
| 41 | Crocevia dei Patti | Regola · Poteri · sempre attivi (senza trigger) | trigger | special | 1 |
...
| 29 | Nucleo del Reattore | Regola · Overdrive · 4 FC necessari | trigger | raro | 1 |
| 30 | Deposito di Rottami | Post-scontro · Perdente · +2 FC | conditional | comune | 2 |
| 43 | Firewall Centrale | Regola · DAN dir. disattivati | limit | raro | 1 |
| 44 | Centrale Energetica | Overdrive · +1 DAN | conditional | comune | 1 |
| 57 | La Grande Forgia | Post-scontro · Chi ha meno PV · +1 PV | conditional | comune | 2 |

## Orathai *(6)*

| id | Nome | Effetto | category | rarità | minTurn |
|----|------|---------|----------|--------|---------|
| 31 | Convergenza delle Ley | Regola · Magnanimo · sempre attivo | trigger | raro | 1 |
| 32 | Radura dell'Anima | Regola · Modificatori POT/DAN disattivati | limit | special | 1 |
| 45 | Cerchio di Evocazione | Regola · Intervento · sempre attivo | trigger | raro | 1 |
| 46 | Fonte del Mana | Post-scontro · Entrambi · +1 FC | conditional | comune | 2 |
| 47 | Sanctum dell'Equilibrio | In scontro · Lega più alta · −5 VA | values | raro | 1 |
| 58 | L'Albero del Giudizio | Regola · Resa dei conti · sempre attivo | trigger | raro | 1 |
...
| 34 | Pianura Divorata | Post-scontro · Entrambi · +1 PV | conditional | comune | 2 |
| 48 | Palude Tossica | Post-scontro · Entrambi · −1 PV | conditional | comune | 2 |
| 49 | Alveare Abbandonato | Regola · Imboscata · sempre attivo | trigger | raro | 1 |
...
| id | Nome | Effetto | category | rarità | minTurn |
|----|------|---------|----------|--------|---------|
| 60 | Volta del Tesoro | Post-scontro · Entrambi · +2 FC | conditional | comune | 2 |
| 61 | Trono d'Ossidiana | Regola · Conquista · valore ×2 | conditional | raro | 1 |
| 62 | Arena delle Scaglie | Regola · Vincitore · più FC investiti (ignora VA) | focus | special | 1 |
| 63 | Caverna del Wyrm | Regola · POT max 5 | limit | raro | 1 |
| 64 | Cova di Scaglie | Imboscata · +1 POT | conditional | comune | 1 |
| 65 | Picco del Drago Caduto | Conquista · +1 FC, −2 PV | conditional | raro | 1 |
...
| 67 | Reggia del Custode | Calcolo VA · Entrambi · FC ÷2 (per eccesso) | focus | special | 1 |
| 68 | Trono della Megera | Regola · Ultimo Desiderio · ×2 | trigger | raro | 1 |
...
| id | Nome | Effetto | category | rarità | minTurn |
|----|------|---------|----------|--------|---------|
| 72 | L'Ultrastrada | Regola · Turbo · sempre attivo | trigger | raro | 1 |
...
| 76 | L'Ultimo Distributore | In scontro · Entrambi · +1 DAN ogni 3 FC propri | focus | comune | 1 |
...
| 79 | Camera Rituale | Overdrive · +1 POT, +1 DAN | conditional | raro | 1 |
