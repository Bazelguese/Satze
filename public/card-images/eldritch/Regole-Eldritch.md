...
Documento di design e procedura di produzione · versione 1.1 · 19 settembre 2026
...
| Testi | Elementi modificabili, separati dall’artwork, con macchie nere dipinte dietro. Alla prima virgola: nome prima, sottotitolo più piccolo dopo. |
| Profondità | Soggetto PNG trasparente e sfondo completo separato, con movimento relativo contenuto. |
| Sovrapposizioni | Obbligatorie per ogni Eldritch e visibili anche a carta ferma: almeno una parte del soggetto deve passare davanti a cornice, nome o blocco di potere/bonus. Informazioni comunque leggibili. |
...
Ordine di composizione di base: **sfondo → soggetto → cornice → porzioni mascherate del soggetto → macchie, anello e testi**. Una porzione selezionata può stare anche sopra l’overlay testuale: scegliere il livello per ciascuna interazione, preservando la comprensione delle informazioni. L’overlay attuale riunisce macchie, anello e tipografia; in un’integrazione futura possono restare componenti distinti.
...
Adattare posizione e scala all’agente. Un titolo lungo non deve coprire volto o elemento distintivo: per Sorethai il soggetto è stato abbassato sotto le due righe del nome. È obbligatorio scegliere almeno una parte che interagisca visibilmente con il layout, anche senza movimento: testa, spalla, mano, arma o magia secondo la composizione.

Usare copie della stessa immagine con la stessa trasformazione e maschere locali, sfumate dove serve. Evitare interruzioni nette a metà braccio o scia. Nome, potere e valori devono rimanere comprensibili anche se una parte dell’illustrazione li sovrappone parzialmente. Verificare la carta alle dimensioni effettive di gioco: una sovrapposizione impercettibile non soddisfa la regola.
...
## Aggiornamento 1.1 — regole vincolanti e Glauson

**Nome e sottotitolo.** Separare alla prima virgola, rimuovere la virgola di separazione dalla resa grafica e mostrare il resto come sottotitolo più piccolo. Le eventuali virgole successive rimangono nel sottotitolo. Il nome completo resta nei dati e nelle descrizioni accessibili. Senza virgola non scatta la separazione automatica. Il sottotitolo è un elemento indipendente e riposizionabile nell’editor.

**Interazione obbligatoria.** Ogni nuova Eldritch deve sovrapporsi chiaramente ad almeno un componente del layout. Non basta avvicinarsi alla cornice o avere il soggetto tecnicamente su un livello separato. Valutare la composizione ferma con la sovrapposizione attiva/disattiva: deve esserci una differenza visibile su un elemento del layout. Il precedente Mezzanotte privo di interazione è un esempio che non soddisfa questa nuova regola; non usarlo come riferimento definitivo per le sovrapposizioni.

**Glauson.** Il nome sorgente è “Glauson il Secondo Architetto”, senza virgola. Questa prova conserva quel nome nei dati e usa esplicitamente `displayName: "Glauson, il Secondo Architetto"` per applicare una separazione editoriale, senza modificare la scheda di gioco. Titolo a destra del martello; sottotitolo sotto. Martello davanti alla cornice sinistra e alla macchia del nome, mano con scalpello davanti alla cornice ma dietro le statistiche. Tre braccia come nell’originale. Cornice Kethran #eebf3c; lega 2, potenza 2, danno 2. Potere Rimonta: +1 POT, +1 DAN. Bonus Rimonta: +2 POT.

Gli esempi precedenti sono conservati come cronologia: non sono tutti stati rigenerati con le nuove regole. Glauson è il primo esempio completo della versione 1.1. L’editor aggiornato gestisce la tipografia; le maschere di sovrapposizione sono nella demo a livelli, da riportare nel tool di composizione.
