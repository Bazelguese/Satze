...
export const DECK_LORE = {
  ...
  "Mascarada": {
    __glyph: "🎭",
    A: {
      code: "M·I", name: "Il Main Event", archetype: "TECH · OPPORTUNISTA",
      flavor: "Ogni lottatore prepara il prossimo ingresso. Il pubblico paga il biglietto una seconda volta.",
      keywords: ["Opportunista", "Vendetta", "Overdrive"],
      leader: { name: "Montgomery \"Deep Piledriver\"", title: "Deep Piledriver", img: null, league: 4, power: 4, damage: 4, ability: "Opportunista: +3 POT" },
    },
    B: {
      code: "M·II", name: "Curtain Call", archetype: "TITLE · FACE",
      flavor: "Il pubblico vuole un eroe. La Mascarada gli concede una vittoria, poi vende il finale.",
      keywords: ["Gloria", "Conquista", "Turbo"],
    ...
    C: {
      ...
      flavor: "Il trucco vero è farsi pagare anche quando si perde.",
      keywords: ["Vendetta", "Opportunista", "Ultimo desiderio"],
