...
export function FirstActEvent({run,choice,setChoice,family,setFamily,commit}) {
  ...
  return <section className="cs-question">
    ...
    <div className="cs-question-body">
      ...
      <div className="cs-question-answers"><p className="cs-kicker">{family?'COME LA TRADUCI IN BATTAGLIA?':'COME VUOI PROSEGUIRE?'}</p>
      ...
      <aside className="cs-question-preview" aria-label="Anteprima del Nascente" aria-live="polite">
        ...
        <div className="cs-roster-card"><CardReworkP4Scaled agent={card} width={200}/></div>
        <p>{card.description}</p><small>Lega esercito: {runLeague(preview || run)}/30</small>
