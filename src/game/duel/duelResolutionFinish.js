...
export function buildDuelBattleResult({
  ...
  pFocusUsed,
  eFocusUsed,
  playerFocusInvested = null,
  enemyFocusInvested = null,
  ...
  pBonusCopied,
  eBonusCopied,
  pEffectiveArmyBonus = null,
  eEffectiveArmyBonus = null,
  ...
  const result = {
    ...
    playerFocusInvested: playerFocusInvested ?? pFocusUsed,
    enemyFocusInvested: enemyFocusInvested ?? eFocusUsed,
    ...
    playerEffectiveArmyBonus: pEffectiveArmyBonus,
    enemyEffectiveArmyBonus: eEffectiveArmyBonus,
