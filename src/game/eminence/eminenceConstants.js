...
export const EMINENCE_PRIMITIVES = {
  ...
  SWAP_POWER_BONUS_TRIGGERS: 'SWAP_POWER_BONUS_TRIGGERS',
  MIRROR_UNSATISFIED_POWER: 'MIRROR_UNSATISFIED_POWER',
  PROPOSE_DEAL: 'PROPOSE_DEAL',
  GRANT_IMMUNE: 'GRANT_IMMUNE',
  GRANT_POOL_FOCUS: 'GRANT_POOL_FOCUS',
  REMOVE_TOXIN: 'REMOVE_TOXIN',
  ESCALATE_ABILITY: 'ESCALATE_ABILITY',
};
...
export const PRIMITIVE_ALLOWED_TARGETS = {
  ...
  [EMINENCE_PRIMITIVES.SWAP_POWER_BONUS_TRIGGERS]: [null],
  [EMINENCE_PRIMITIVES.MIRROR_UNSATISFIED_POWER]: [null],
  [EMINENCE_PRIMITIVES.PROPOSE_DEAL]: [null],
  [EMINENCE_PRIMITIVES.GRANT_IMMUNE]: [
    PRIMITIVE_TARGETS.OWN_AGENT,
    PRIMITIVE_TARGETS.ENEMY_AGENT,
    PRIMITIVE_TARGETS.SELF,
    PRIMITIVE_TARGETS.BOTH,
  ],
  [EMINENCE_PRIMITIVES.GRANT_POOL_FOCUS]: [
    PRIMITIVE_TARGETS.SELF,
    PRIMITIVE_TARGETS.OPPONENT,
    PRIMITIVE_TARGETS.BOTH,
  ],
  [EMINENCE_PRIMITIVES.REMOVE_TOXIN]: [
    PRIMITIVE_TARGETS.OPPONENT,
    PRIMITIVE_TARGETS.ENEMY_AGENT,
    PRIMITIVE_TARGETS.SELF,
    PRIMITIVE_TARGETS.CHOSEN,
  ],
  [EMINENCE_PRIMITIVES.ESCALATE_ABILITY]: [null],
};
