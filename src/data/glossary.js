...
export const GLOSSARY_TERMS = [
  ...
  { term: 'Valore Assalto', abbr: 'VA', category: 'concetti', desc: "POT × FC + modificatori. Chi ha VA più alto vince. (Min: POT base)", detail: "Il VA determina chi vince lo scontro. Formula: VA = POT × FC + modificatori (da poteri, bonus armata, effetti dei campi). In parità di VA vince chi ha Lega più bassa, poi POT più bassa. Il VA non può mai essere inferiore alla POT base dell'Agente." },
