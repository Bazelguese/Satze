...
/** Mappa `tema` → animazione reveal. Armate senza entry usano `default` (per ora: Enclave, Ratti, Patto, Khemet). */
...
/** @returns {'default'|'swirl'|'frammenti'|'sipario'|'hud'|'onda'|'morsi'} */
